  ...
  return (
    <>
      ...
      <Article>
        ...
        <ArticleParagraph>Помимо работы, мне нравится рисовать, заниматься математикой, изучать кибербезопасность и нейросеть. Ещё люблю отличный кофе и минимализм.</ArticleParagraph>
