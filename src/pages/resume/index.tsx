  ...
  return (
    <>
      ...
      <Article>
        ...
        <ArticleParagraph>С 2011 года погрузился в мир информационных технологий. Я пробовал разные направления, выбрал фронтенд — всё, что связано с веб-разработкой, сайтами и тем, что их окружает — чтобы сделать мир чуточку лучше. За время работы накопился немалый опыт — разрабатываю веб-приложения, создаю сайты, помогаю улучшить дизайн, также даю советы по саморазвитию.</ArticleParagraph>
